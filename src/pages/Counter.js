              ...
              <section className="wrapper style5">
                <div className="inner">
                  <h3>Lorem ipsum dolor</h3>
                            ...
                            <h3>Lorem ipsum dolor</h3>
                            <div className="col-4 col-12-small">
								<input onChange={()=>this.increment21()} type="radio" id="q2.1" name="2demo-priority" />
								<label htmlFor="q2.1">1</label>
							</div>
							<div className="col-4 col-12-small">
								<input onChange={()=>this.increment22()} type="radio" id="q2.2" name="2demo-priority" />
								<label htmlFor="q2.2">2</label>
							</div>
							<div className="col-4 col-12-small">
								<input onChange={()=>this.increment23()} type="radio" id="q2.3" name="2demo-priority" />
								<label htmlFor="q2.3">3</label>
							</div>
                            <div className="col-4 col-12-small">
								<input onChange={()=>this.increment24()} type="radio" id="q2.4" name="2demo-priority" />
								<label htmlFor="q2.4">4</label>
							</div>
							<div className="col-4 col-12-small">
								<input onChange={()=>this.increment25()} type="radio" id="q2.5" name="2demo-priority" />
